    ...
    html: `
      <div style="background: #f6f9f7; padding: 32px 16px; font-family: Arial, sans-serif; color: #101828;">
        <div style="max-width: 640px; margin: 0 auto; background: #ffffff; border-radius: 16px; overflow: hidden; border: 1px solid #e6efe9;">
          <div style="padding: 24px 28px; background: #004370; color: #ffffff;">
            <p style="margin: 0; font-size: 12px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; color: #a7d7f3;">BIWS Website</p>
          ...
          <div style="padding: 24px 14px;">
            ...
            <div style="margin: 24px 14px 0;">
              <p style="margin: 0 0 8px; font-size: 12px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; color: #005a8f;">Message</p>
