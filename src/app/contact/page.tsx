...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL ?? "https://www.beguminayat.com"}/contact` },
  openGraph: {
    title: "Contact — BIWS Orphanage Lahore | Begum Inayat Welfare Society",
    description:
    ...
    url: `${process.env.NEXT_PUBLIC_SITE_URL ?? "https://www.beguminayat.com"}/contact`,
  },
};
